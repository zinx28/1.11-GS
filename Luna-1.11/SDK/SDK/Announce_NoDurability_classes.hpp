...
static_assert(sizeof(AAnnounce_NoDurability_C) == 0x0004C0, "Wrong size on AAnnounce_NoDurability_C");
static_assert(offsetof(AAnnounce_NoDurability_C, UberGraphFrame) == 0x0004B0, "Member 'AAnnounce_NoDurability_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAnnounce_NoDurability_C, DefaultSceneRoot) == 0x0004B8, "Member 'AAnnounce_NoDurability_C::DefaultSceneRoot' has a wrong offset!");
