...
// Parameters:
// class FName                             Param_SquadId                                          (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Icon(class FName& Param_SquadId)
{
	static class UFunction* Func = nullptr;
	...
	Param_SquadId = Parms.Param_SquadId;
}
...
void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Rating(class FName& Param_SquadId)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Name(class FName Param_SquadId)
{
	static class UFunction* Func = nullptr;
