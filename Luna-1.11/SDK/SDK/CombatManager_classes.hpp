...
static_assert(sizeof(ACombatManager_C) == 0x000BE8, "Wrong size on ACombatManager_C");
static_assert(offsetof(ACombatManager_C, DefaultSceneRoot) == 0x000BE0, "Member 'ACombatManager_C::DefaultSceneRoot' has a wrong offset!");
