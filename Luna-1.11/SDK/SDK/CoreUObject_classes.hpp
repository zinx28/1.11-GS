...
public:
	...
	UClass*                                       Class;                                             // 0x0010(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
public:
	...
	template <typename _ClassTemplate>
	bool IsA() {
		return IsA(_ClassTemplate::StaticClass());
	}
	UObject* Cast(UClass* Class) {
		return IsA(Class) ? this : nullptr;
	}

	template <typename T>
	T* Cast() {
		return (T*)Cast(T::StaticClass());
	}

	template<typename UEType = UObject>
	static UEType* FindObjectInclude(const std::string& Name, EClassCastFlags RequiredType = EClassCastFlags::None) {
