...
{
public:
	class UFortItemDefinition*                    ItemDef;                                           // 0x0090(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<TSoftObjectPtr<class UTexture2D>>      RatingIcons;                                       // 0x0040(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortHealthyGamingData) == 0x000008, "Wrong alignment on FFortHealthyGamingData");
static_assert(sizeof(FFortHealthyGamingData) == 0x000050, "Wrong size on FFortHealthyGamingData");
...
static_assert(offsetof(FFortHealthyGamingData, RatingIcons) == 0x000040, "Member 'FFortHealthyGamingData::RatingIcons' has a wrong offset!");
