...
static_assert(sizeof(AGCN_BluGloPylon_Energy_Activate_C) == 0x0004A0, "Wrong size on AGCN_BluGloPylon_Energy_Activate_C");
static_assert(offsetof(AGCN_BluGloPylon_Energy_Activate_C, IconTexture) == 0x000490, "Member 'AGCN_BluGloPylon_Energy_Activate_C::IconTexture' has a wrong offset!");
