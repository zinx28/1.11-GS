...
static_assert(sizeof(AGCN_Commando_IncendiaryRoundsDOT_C) == 0x0004A0, "Wrong size on AGCN_Commando_IncendiaryRoundsDOT_C");
static_assert(offsetof(AGCN_Commando_IncendiaryRoundsDOT_C, UberGraphFrame) == 0x000490, "Member 'AGCN_Commando_IncendiaryRoundsDOT_C::UberGraphFrame' has a wrong offset!");
