...
public:
	...
	TArray<class FString>                         DenyItemTemplateIds;                               // 0x01D8(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FCatalogOffer) == 0x000008, "Wrong alignment on FCatalogOffer");
static_assert(sizeof(FCatalogOffer) == 0x0001E8, "Wrong size on FCatalogOffer");
...
static_assert(offsetof(FCatalogOffer, DenyItemTemplateIds) == 0x0001D8, "Member 'FCatalogOffer::DenyItemTemplateIds' has a wrong offset!");
