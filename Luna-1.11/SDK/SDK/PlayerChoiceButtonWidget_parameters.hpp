...
{
public:
	class UFortBaseButton*                        Param_Button;                                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature, Param_Button) == 0x000000, "Member 'PlayerChoiceButtonWidget_C_BndEvt__Button_K2Node_ComponentBoundEvent_98_FortBaseButtonClicked__DelegateSignature::Param_Button' has a wrong offset!");
...
public:
	...
	int32                                         Param_ChoiceID;                                    // 0x0050(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayerChoiceWidget_C*                  Param_Owner;                                       // 0x0058(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(PlayerChoiceButtonWidget_C_ConfigureChoice, Param_ChoiceID) == 0x000050, "Member 'PlayerChoiceButtonWidget_C_ConfigureChoice::Param_ChoiceID' has a wrong offset!");
static_assert(offsetof(PlayerChoiceButtonWidget_C_ConfigureChoice, Param_Owner) == 0x000058, "Member 'PlayerChoiceButtonWidget_C_ConfigureChoice::Param_Owner' has a wrong offset!");
