...
{
public:
	class UArrowComponent*                        Arrow;                                             // 0x06E0(0x0008)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(APlayerSpawnPlacementActor_C) == 0x0006E8, "Wrong size on APlayerSpawnPlacementActor_C");
static_assert(offsetof(APlayerSpawnPlacementActor_C, Arrow) == 0x0006E0, "Member 'APlayerSpawnPlacementActor_C::Arrow' has a wrong offset!");
