...
static_assert(offsetof(RatingWidget_NUI_C_PlayerInfoChanged, Param_UniqueId) == 0x000000, "Member 'RatingWidget_NUI_C_PlayerInfoChanged::Param_UniqueId' has a wrong offset!");
