...
{
public:
	struct FSocialListStyle                       Style;                                             // 0x0030(0x21F0)(Edit, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USocialListStyleDataAsset) == 0x002220, "Wrong size on USocialListStyleDataAsset");
...
public:
	...
	uint8                                         Pad_C0[0x5D60];                                    // 0x00C0(0x5D60)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialStyleDataAsset) == 0x005E20, "Wrong size on USocialStyleDataAsset");
