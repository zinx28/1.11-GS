...
static_assert(sizeof(UTextStyleMinusButtonMinusOutlineMinusMMinusDisabled_C) == 0x0000C0, "Wrong size on UTextStyleMinusButtonMinusOutlineMinusMMinusDisabled_C");
