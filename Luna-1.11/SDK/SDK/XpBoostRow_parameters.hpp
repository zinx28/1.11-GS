...
{
public:
	struct FUniqueNetIdRepl                       Player_to_Boost;                                   // 0x0000(0x0028)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
};
...
static_assert(sizeof(XpBoostRow_C_Give_Boost_Clicked__DelegateSignature) == 0x000028, "Wrong size on XpBoostRow_C_Give_Boost_Clicked__DelegateSignature");
...
public:
	...
	ESlateVisibility                              Temp_byte_Variable2;                               // 0x0258(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x0259(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select_Default;                             // 0x025A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsLocalPlayersUniqueID_ReturnValue;       // 0x025B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_25C[0x4];                                      // 0x025C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortMcpContext*                        CallFunc_GetContext_ReturnValue2;                  // 0x0260(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortMcpContext*                        CallFunc_GetContext_ReturnValue3;                  // 0x0268(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue; // 0x0270(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue2; // 0x0274(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array3;                           // 0x0308(0x0010)(ZeroConstructor, ReferenceParm)
	class FText                                   CallFunc_Format_ReturnValue2;                      // 0x0318(0x0018)()
	class FText                                   CallFunc_Format_ReturnValue3;                      // 0x0330(0x0018)()
};
static_assert(alignof(XpBoostRow_C_Update_Party_Member) == 0x000008, "Wrong alignment on XpBoostRow_C_Update_Party_Member");
static_assert(sizeof(XpBoostRow_C_Update_Party_Member) == 0x000348, "Wrong size on XpBoostRow_C_Update_Party_Member");
...
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, Temp_byte_Variable) == 0x0001B8, "Member 'XpBoostRow_C_Update_Party_Member::Temp_byte_Variable' has a wrong offset!");
...
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, Temp_byte_Variable2) == 0x000258, "Member 'XpBoostRow_C_Update_Party_Member::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, Temp_bool_Variable) == 0x000259, "Member 'XpBoostRow_C_Update_Party_Member::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_Select_Default) == 0x00025A, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_IsLocalPlayersUniqueID_ReturnValue) == 0x00025B, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_IsLocalPlayersUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_GetContext_ReturnValue2) == 0x000260, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_GetContext_ReturnValue3) == 0x000268, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_GetContext_ReturnValue3' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue) == 0x000270, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue2) == 0x000274, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_GetPlayersXPPercentContributionToLocalPlayer_ReturnValue2' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_MakeStruct_FormatArgumentData2) == 0x000278, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_MakeStruct_FormatArgumentData2' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_MakeStruct_FormatArgumentData3) == 0x0002B8, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_MakeStruct_FormatArgumentData3' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_MakeArray_Array2) == 0x0002F8, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_MakeArray_Array2' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, K2Node_MakeArray_Array3) == 0x000308, "Member 'XpBoostRow_C_Update_Party_Member::K2Node_MakeArray_Array3' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_Format_ReturnValue2) == 0x000318, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_Format_ReturnValue2' has a wrong offset!");
static_assert(offsetof(XpBoostRow_C_Update_Party_Member, CallFunc_Format_ReturnValue3) == 0x000330, "Member 'XpBoostRow_C_Update_Party_Member::CallFunc_Format_ReturnValue3' has a wrong offset!");
