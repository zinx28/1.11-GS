...
UAthenaCharacterItemDefinition* Player::GetRandomDefault(int* OutIdx = nullptr) {
	int Num = (rand() % 8);
...
UFortResourceItemDefinition* Player::GetResourceItemDef(EFortResourceType Type)
{
...
void Player::OnDamageServer(ABuildingContainer* Container, float Damage, const struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, const struct FHitResult& HitInfo, class AFortPlayerControllerAthena* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
...
FFortAthenaLoadout Player::GetLoadout(AFortPlayerControllerAthena* Controller) {
	if (Controller) {
...
void Player::EquipSkin(AFortPlayerControllerAthena* Controller, UAthenaCharacterItemDefinition* Skin) {
...
void Player::ServerLoadingScreenDropped_Hook(AFortPlayerControllerAthena* Controller) {
...
void Player::ServerAttemptInteract(AFortPlayerController* PlayerController, AActor* ReceivingActor, UPrimitiveComponent* InteractComponent, ETInteractionType InteractType)
{
...
void Player::ServerReturnToMainMenu(AFortPlayerController* PlayerController) { //WHAT THE FUCK IS THE POINT OF THIS
...
void Player::ServerSpawnInventoryDrop(AFortPlayerControllerAthena* PC, const struct FGuid& ItemGuid, int32 Count)
{
	if (PC && !PC->IsInAircraft())
		Inventory::RemoveItem(PC, ItemGuid, true, Count);
}

__int64 Player::AFortPlayerController_GetAthenaLoadoutWithOverrides(AFortPlayerControllerAthena* Controller, __int64 a2, __int64 a3)
{
...
void Player::ApplyHomeBaseEffectsOnPlayerSetup(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, char a6, unsigned __int8 a7)
{
...
void Player::ClientOnPawnDied(AFortPlayerControllerAthena* DeadController, const struct FFortPlayerDeathReport& DeathReport)
{
...
void Player::ServerHandlePickup(AFortPlayerPawnAthena* Pawn, class AFortPickup* Pickup, float InFlyTime, const struct FVector& InStartDirection, bool bPlayPickupSound)
{
...
void Player::ServerSwapItemsInternal(AFortQuickBars* AmICooked, EFortQuickBars QuickBarA, int32 SlotIndexA, EFortQuickBars QuickBarB, int32 SlotIndexB)
{
...
__int64 Player::OnPickupComplete(AFortPickup* a1)
{
...
void Player::AirCraftStartPhase(AFortGameModeAthena* GameMode)
{
...
void Player::ServerEditBuildingActor(AFortPlayerControllerAthena* PC, ABuildingSMActor* BuildingActorToEdit, TSubclassOf<ABuildingSMActor> NewBuildingClass, int32 RotationIterations, bool bMirrored)
{
...
void Player::ServerRepairBuildingActor(AFortPlayerControllerAthena* PC, ABuildingSMActor* BuildingActorToRepair)
{
...
void Player::ServerCreateBuildingActor(AFortPlayerControllerAthena* Controller, FBuildingClassData BuildingClassData, FVector_NetQuantize10 BuildLoc, FRotator Rotator, bool bMirrored)
{
	if (!Controller)
		return;
...
void Player::ServerBeginEditingBuildingActor(AFortPlayerController* Player, ABuildingSMActor* Building)
{
...
void Player::ServerEndEditingBuildingActor(AFortPlayerControllerAthena* PC, ABuildingSMActor* BuildingActorToStopEditing)
{
...
void Player::ServerSpawnDeco(AFortTrapTool* DecoTool, const FVector& Location, const FRotator& Rotation, ABuildingSMActor* AttachedActor)
{
...
void Player::ServerPlayEmoteItem(AFortPlayerControllerAthena* PC, UFortMontageItemDefinitionBase* EmoteAsset)
{
	...
	if (DanceItemDef && AbilityToUse) {
		...
		Abilities::GiveAbility(PC->MyFortPawn->AbilitySystemComponent, &Spec.Handle, Spec);
