...
static_assert(sizeof(AAnnounce_Gen_Quest_Conversation_C) == 0x000430, "Wrong size on AAnnounce_Gen_Quest_Conversation_C");
static_assert(offsetof(AAnnounce_Gen_Quest_Conversation_C, UberGraphFrame) == 0x000428, "Member 'AAnnounce_Gen_Quest_Conversation_C::UberGraphFrame' has a wrong offset!");
