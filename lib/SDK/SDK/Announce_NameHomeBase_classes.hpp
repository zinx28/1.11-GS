...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Announce_NameHomeBase_C;            // 0x0590(0x0008)(Transient, DuplicateTransient)
...
static_assert(sizeof(AAnnounce_NameHomeBase_C) == 0x000598, "Wrong size on AAnnounce_NameHomeBase_C");
static_assert(offsetof(AAnnounce_NameHomeBase_C, UberGraphFrame_Announce_NameHomeBase_C) == 0x000590, "Member 'AAnnounce_NameHomeBase_C::UberGraphFrame_Announce_NameHomeBase_C' has a wrong offset!");
