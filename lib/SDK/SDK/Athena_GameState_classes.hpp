...
static_assert(sizeof(AAthena_GameState_C) == 0x0014F8, "Wrong size on AAthena_GameState_C");
static_assert(offsetof(AAthena_GameState_C, DefaultSceneRoot) == 0x0014F0, "Member 'AAthena_GameState_C::DefaultSceneRoot' has a wrong offset!");
