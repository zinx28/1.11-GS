...
static_assert(sizeof(AB_IngameMap_SceneCaptureBlurryNew_C) == 0x000388, "Wrong size on AB_IngameMap_SceneCaptureBlurryNew_C");
static_assert(offsetof(AB_IngameMap_SceneCaptureBlurryNew_C, UberGraphFrame) == 0x000380, "Member 'AB_IngameMap_SceneCaptureBlurryNew_C::UberGraphFrame' has a wrong offset!");
