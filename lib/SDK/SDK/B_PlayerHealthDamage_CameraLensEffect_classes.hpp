...
static_assert(sizeof(AB_PlayerHealthDamage_CameraLensEffect_C) == 0x000430, "Wrong size on AB_PlayerHealthDamage_CameraLensEffect_C");
static_assert(offsetof(AB_PlayerHealthDamage_CameraLensEffect_C, UberGraphFrame) == 0x000420, "Member 'AB_PlayerHealthDamage_CameraLensEffect_C::UberGraphFrame' has a wrong offset!");
