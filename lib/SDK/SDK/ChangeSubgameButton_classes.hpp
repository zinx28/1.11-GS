...
public:
	...
	class UClass*                                 ButtonStyle;                                       // 0x0238(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortBrushSize                                BrushSize;                                         // 0x0240(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UChangeSubgameButton_C) == 0x000248, "Wrong size on UChangeSubgameButton_C");
...
static_assert(offsetof(UChangeSubgameButton_C, ButtonStyle) == 0x000238, "Member 'UChangeSubgameButton_C::ButtonStyle' has a wrong offset!");
static_assert(offsetof(UChangeSubgameButton_C, BrushSize) == 0x000240, "Member 'UChangeSubgameButton_C::BrushSize' has a wrong offset!");
