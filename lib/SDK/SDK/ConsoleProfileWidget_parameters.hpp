...
static_assert(offsetof(ConsoleProfileWidget_C_SetDisplayName, Param_DisplayName) == 0x000000, "Member 'ConsoleProfileWidget_C_SetDisplayName::Param_DisplayName' has a wrong offset!");
