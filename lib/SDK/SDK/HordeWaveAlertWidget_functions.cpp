...
void UHordeWaveAlertWidget_C::OnWaveStarted(const class FText& LevelText, int32 Level, const class FText& Param_WaveText, int32 WaveNum)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Level = Level;
	Parms.Param_WaveText = std::move(Param_WaveText);
