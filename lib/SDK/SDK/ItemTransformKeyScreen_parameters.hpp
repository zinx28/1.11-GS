...
public:
	...
	EConversionControlKeyRequest                  CallFunc_Determine_Key_Types_to_See_RequestType;   // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EConversionControlKeyRequest                  CallFunc_Determine_Key_Types_to_See_RequestType2;  // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
