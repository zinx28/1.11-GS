...
static_assert(sizeof(ALevelSequenceActor) == 0x0003E8, "Wrong size on ALevelSequenceActor");
...
static_assert(offsetof(ALevelSequenceActor, SequencePlayer) == 0x0003A0, "Member 'ALevelSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, LevelSequence) == 0x0003A8, "Member 'ALevelSequenceActor::LevelSequence' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, AdditionalEventReceivers) == 0x0003C0, "Member 'ALevelSequenceActor::AdditionalEventReceivers' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInOptions) == 0x0003D0, "Member 'ALevelSequenceActor::BurnInOptions' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BindingOverrides) == 0x0003D8, "Member 'ALevelSequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x0003E0, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
