...
void UOptionsMenuSlider_Light_C::Update_Slider(const class FText& Slider_Text, float Slider_Value, const class FText& Param_Hover_Text, class UCommonTextBlock* Tooltip_Text_Block)
{
	static class UFunction* Func = nullptr;
