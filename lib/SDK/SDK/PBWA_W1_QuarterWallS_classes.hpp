...
static_assert(sizeof(APBWA_W1_QuarterWallS_C) == 0x000E58, "Wrong size on APBWA_W1_QuarterWallS_C");
static_assert(offsetof(APBWA_W1_QuarterWallS_C, UberGraphFrame) == 0x000E50, "Member 'APBWA_W1_QuarterWallS_C::UberGraphFrame' has a wrong offset!");
