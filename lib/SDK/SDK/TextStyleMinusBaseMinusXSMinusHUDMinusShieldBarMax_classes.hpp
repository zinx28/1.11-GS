...
static_assert(sizeof(UTextStyleMinusBaseMinusXSMinusHUDMinusShieldBarMax_C) == 0x0000C0, "Wrong size on UTextStyleMinusBaseMinusXSMinusHUDMinusShieldBarMax_C");
