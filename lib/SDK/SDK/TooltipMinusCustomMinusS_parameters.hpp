...
public:
	...
	ESlateVisibility                              K2Node_Select2_Default;                            // 0x0014(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue;                    // 0x0015(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select3_Default;                            // 0x0016(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(TooltipMinusCustomMinusS_C_Get_Icon_Brush) == 0x0000F0, "Wrong size on TooltipMinusCustomMinusS_C_Get_Icon_Brush");
...
static_assert(offsetof(TooltipMinusCustomMinusS_C_Get_Icon_Brush, CallFunc_MakeBrushFromAsset_ReturnValue) == 0x000078, "Member 'TooltipMinusCustomMinusS_C_Get_Icon_Brush::CallFunc_MakeBrushFromAsset_ReturnValue' has a wrong offset!");
