...
struct FTransform ATrap_Floor_Player_Jump_Pad_C::GetFireLocationAndRotation() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Trap_Floor_Player_Jump_Pad_C", "GetFireLocationAndRotation");

	Params::Trap_Floor_Player_Jump_Pad_C_GetFireLocationAndRotation Parms{};
