...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FUniqueNetIdRepl                 Param_Player_to_Boost                                  (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)

void UXpBoosts_C::Give_Boost_Clicked(const struct FUniqueNetIdRepl& Param_Player_to_Boost)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Player_to_Boost = std::move(Param_Player_to_Boost);
