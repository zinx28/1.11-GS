	...
	namespace ContainerImpl
	{
		...
		public:
			...
			FORCEINLINE void Set(const int32 Index, const bool Value, bool bIsSettingAllZero = false)
			{
				...
				FBitReference(DWORDIndex, Mask).SetBit(Value);
			}
		};
...
#pragma warning(suppress: 4244)
	...
	*/
	...
	public:
		...
		FORCEINLINE const int32 Find(const SetElementType& ElementToLookFor) const
		{
		...
		FORCEINLINE bool Remove(const SetElementType& ElementToRemove)
		{
